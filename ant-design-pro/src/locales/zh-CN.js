...
export default {
  ...
  'menu.list.updowntable': '上下列表',
  'menu.list.leftrighttable': '左右列表',
  'menu.list.basicsearch': '通用查询列表',
  'menu.list.basicsearch2': '通用查询列表2',
  'menu.list.basicsearch3': '通用查询列表3',
  ...
  'menu.joeymenu':'测试列表页',
  'menu.joeymenu.list':'测试列表页一',
  'menu.joeymenu.list2':'测试列表页二',
  'menu.wf':'工作流',
  'menu.wf.demo':'工作流Demo',
